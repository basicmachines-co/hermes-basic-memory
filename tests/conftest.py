...
def make_scripted_actor(bm, session=None, raise_at_init: BaseException | None = None,
                        fake_tools: list | None = None):
    """
    ...
    async def _fake_main():
        ...
        actor._tools_cache = fake_tools or [
            {"name": n, "description": ""}
            for n in [
                "search_notes", "read_note", "write_note", "edit_note",
                "build_context", "delete_note", "move_note",
            ]
        ]
        actor._ready.set()
